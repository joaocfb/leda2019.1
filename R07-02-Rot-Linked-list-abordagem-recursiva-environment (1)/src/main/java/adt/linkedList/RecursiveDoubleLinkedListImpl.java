...
public class RecursiveDoubleLinkedListImpl<T> extends RecursiveSingleLinkedListImpl<T> implements DoubleLinkedList<T> {
	...
	public void insertFirst(T element) {
		...
		if (isEmpty()) {
			...
			this.setNext((RecursiveSingleLinkedListImpl<T>) (new RecursiveDoubleLinkedListImpl<>().data = null));
			this.setPrevious((RecursiveDoubleLinkedListImpl<T>) (new RecursiveDoubleLinkedListImpl<>().data = null));
